...
class AnnouncementsControllerTest < ActionController::TestCase
  ...
  test "should create announcement" do
    assert_difference('Announcement.count') do
      post :create, announcement: { content: @announcement.content, created_at: @announcement.created_at, updated_at: @announcement.updated_at }
    end
  ...
  test "should update announcement" do
    patch :update, id: @announcement, announcement: { content: @announcement.content, created_at: @announcement.created_at, updated_at: @announcement.updated_at }
    assert_redirected_to announcement_path(assigns(:announcement))
  end
